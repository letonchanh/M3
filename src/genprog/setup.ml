...
(* OASIS_START *)
(* DO NOT EDIT (digest: d04d77e28d761a380efd76642ee84276) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Generating a program from an MBA expression to collect traces"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "genprog.ml"})
            ];
     ...
     oasis_digest = Some "V\b\\X\227\b\198o\184\021\185\133G\247|\169";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
