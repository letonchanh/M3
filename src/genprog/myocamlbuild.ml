(* OASIS_START *)
(* DO NOT EDIT (digest: d9025bf1f3d143d3d909ccc41ae90b8e) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_executable_genprog_byte"; "ocaml"; "link"; "byte"],
            [
          ...
          (["oasis_executable_genprog_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_genprog_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_genprog_native"; "ocaml"; "ocamldep"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_genprog_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_executable_genprog_native"; "ocaml"; "compile"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
